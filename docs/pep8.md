...
สำหรับ DocString ที่อธิบายฟังก์ชันนั้น ก็ต้องอธืบายว่าฟังก์ชันนั้นทำงานเพื่ออะไร หรือว่ากำลังจะทำอะไรอยู่
...
เป็นคำเตือนที่เกิดขึ้นจากว่า น้องทำการเขียน Function และรับ Parameter มากเกินไป
