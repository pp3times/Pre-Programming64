...
## Missing Docstring
Docstring คือ comment เพื่อบอกว่าฟังก์ชัน หรือ โปรแกรมนั้นๆ ทำงานเพื่ออะไร โดยทุก function ละหัวไฟล์ (บรรทัดที่ 1) จะต้องมี Docstring กำกับ
...
สำหรับ Docstring ที่อธิบายฟังก์ชันนั้น ก็ต้องอธืบายว่าฟังก์ชั้นนั้นทำงานเพื่ออะไร หรือว่ากำลังจะทำอะไรอยู่

---

## Missing final new line
เป็นเรื่องของการลืมสร้างบรรทัดใหม่ เมื่อจบการทำงานของโปรแกรมหรือจบการทำงานของฟังก์ชันๆ
...
## Invalid Syntax
การใช้ฟังก์ชันที่ใช้ชื่อผิด ใช้ผิดวิธี โมดูลขาด argument หรือ ไม่ได้เรียกโมดูลที่ต้องการใช้มาก่อน หรือก็คือไม่สามารถอ่านโค๊ตบรรทัดนั้นๆได้
...
3|Variable Name is the same as function|ชื่อตัวแปรเหมือนชื่อฟังก์ชัน|เช่น<br>`if`
...
Pylint จะด่า เพราะน้องส่งตัวแปรให้กับฟังก์ชัน calculate มากเกินไป :(
